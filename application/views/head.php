                ...
                <li>
                    <?php
                        if (isset($_COOKIE['sid'])) {
                            ...
                            echo '<li><a href="/user"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;个人中心</a></li>';
                            echo '<li><a href="/setting"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;设置</a></li>';
                            echo '<li class="divider"></li>';
                            echo '<li><a href="/layout"><span class="glyphicon glyphicon-off"></span>&nbsp;&nbsp;登出</a></li>';
                            echo '</ul>';
                        } else {
